...
const Workflow: React.FC = () => {
    return (
        <div id="workflow" className="z-10 px-6 md:px-10 py-16 lg:py-32 w-full max-w-7xl border-white/5 border-t mr-auto ml-auto relative">
            <div className="flex flex-col md:flex-row justify-between md:items-end mb-12 md:mb-20 gap-8">
                <div className="max-w-3xl">
                    ...
                    <h2 className="text-4xl md:text-6xl font-medium tracking-tighter text-off-white animate-on-scroll [animation:fadeSlideIn_1s_cubic-bezier(0.2,0.8,0.2,1)_0.3s_both] mb-4 md:mb-6">
            ...
            <div className="flex flex-col w-full max-w-5xl mx-auto relative">
                {/* Vertical Line */}
                <div className="absolute left-6 md:left-8 top-8 bottom-8 w-px bg-gradient-to-b from-lumina-500 via-white/10 to-transparent"></div>
